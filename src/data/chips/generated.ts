...
export const ESP12F_LAYOUT: PackageLayout = {
  name: 'ESP-12F',
  left: [{ pinNumber: 1, label: 'RST' }, { pinNumber: 2, gpio: 17 }, { pinNumber: 3, label: 'EN' }, { pinNumber: 4, gpio: 16 }, { pinNumber: 5, gpio: 14 }, { pinNumber: 6, gpio: 12 }, { pinNumber: 7, gpio: 13 }, { pinNumber: 8, label: '3V3' }],
